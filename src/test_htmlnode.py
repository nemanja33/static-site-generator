...
class TestHTMLNode(unittest.TestCase):
  def test_eq(self):
    el = HTMLNode(ElementType.P, "first tag", { "class": "p" })
    html1 = el.props_to_html()
    el2 = HTMLNode(ElementType.P, "first tag", { "class": "p" })
  ...
  def test_props(self):
    el = HTMLNode(ElementType.A, "link", { "class": "wrap"})
  ...
  def test_img(self):
    child_node = LeafNode(ElementType.IMG.value, "alt", { "src": "image.jpg" })
    parent_node = ParentNode("div", [child_node])
  ...
  def test_deep_nested(self):
    ...
    child_2 = ParentNode(ElementType.P.value, [child_1])
    child_3 = ParentNode(ElementType.A.value, [child_2], { "href": "/"})
    child_4 = ParentNode(ElementType.LI.value, [child_3])
    parent = ParentNode(ElementType.UL.value, [child_4])
